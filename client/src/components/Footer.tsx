      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-2xl font-bold text-primary">Aaswad</h3>
            <p className="text-muted-foreground leading-relaxed">
              Experience the finest culinary journey with authentic Indian flavors and traditional techniques.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-muted-foreground">
                ...
                <span>Manvel Pada, Virar East,<br />Maharashtra, India</span>
              </li>
              ...
              <li className="flex items-center gap-3 text-muted-foreground">
                ...
                <span>reservations@aaswad.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border/10 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Aaswad Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
